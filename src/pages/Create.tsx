            ...
            <div className="max-w-4xl mx-auto px-6 pt-20 pb-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-300">
                        Transform any topic into an engaging micro-lesson
                    </p>
                </div>
                        ...
                        {!generatedLesson ? (
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-400">
                                    Enter a topic to generate your lesson
                                    preview
                                </p>
                            </div>
                        ) : (
                            <div className="space-y-6">
                                ...
                                <div className="bg-gray-700/50 rounded-lg p-4">
                                    ...
                                    <p className="text-white mb-3">
                                        {generatedLesson.quiz.question}
                                    </p>
                                    <div className="space-y-2">
                                        {generatedLesson.quiz.options.map(
                ...
                <Card className="bg-gray-800/50 border-gray-700 p-6 mt-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-4 text-sm text-gray-400">
                        <div>
                            ...
                            Instead of "JavaScript," try "JavaScript array
                        ...
                        <div>
                            ...
                            Focus on one key concept that can be explained in 2
                            minutes.
                        </div>
                        <div>
                            ...
                            Include real-world examples that learners can try
                            immediately.
                        </div>
                    </div>
                </Card>
