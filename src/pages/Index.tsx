                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="mb-6 md:mb-8">
                        <div className="inline-flex items-center px-4 py-2 bg-purple-500/20 rounded-full border border-purple-400/30 backdrop-blur-sm mb-6 animate-fadeIn">
                            ...
                            <span className="text-purple-300 text-sm font-medium">
                                Learn anything in bite-sized lessons
                            </span>
                        </div>
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed animate-fadeIn delay-300">
                            Watch quick lessons, take instant quizzes, and
                            unlock achievements.
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-slideUp delay-500">
                        <Link to="/feed">
                            <Button
                                size="lg"
                                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-purple-500/25 w-full sm:w-auto"
                            >
                        ...
                        <Button
                            variant="outline"
                            size="lg"
                            className="px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-105 w-full sm:w-auto"
                        >
                            Join Waiting List
            ...
            <div className="relative z-10 py-16 px-4">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
                        Why Choose{" "}
                        <span className="text-purple-400">Ebite</span>?
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        <Card className="bg-gray-800/50 border-gray-700 p-6 md:p-8 rounded-3xl backdrop-blur-sm hover:bg-gray-700/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                Bite-sized video lessons that fit into your busy
                                schedule. Learn new concepts in just 2-5
                                minutes.
                            </p>
                        </Card>
                        ...
                        <Card className="bg-gray-800/50 border-gray-700 p-6 md:p-8 rounded-3xl backdrop-blur-sm hover:bg-gray-700/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                Test your knowledge immediately with interactive
                                quizzes and earn badges for your achievements.
                            </p>
                        </Card>
                        ...
                        <Card className="bg-gray-800/50 border-gray-700 p-6 md:p-8 rounded-3xl backdrop-blur-sm hover:bg-gray-700/50 transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            ...
                            <p className="text-gray-400 leading-relaxed">
                                Share your progress, challenge friends, and
                                learn together with thousands of other learners.
                            </p>
                        </Card>
                    </div>
                </div>
            ...
            <div className="relative z-10 py-16 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                        Join thousands of learners who are already learning with
                        Ebite. Your first lesson is just a click away.
                    </p>

                    <Link to="/feed">
                        <Button
                            size="lg"
                            className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-12 py-4 text-xl font-semibold rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-purple-500/25"
                        >
